...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.carattachments.create') }}" 
    deletebutton="{{ route('admin.carattachments.deleteAll') }}" 
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/carattachments')])
@endsection
