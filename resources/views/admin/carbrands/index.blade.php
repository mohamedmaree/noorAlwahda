...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.carbrands.create') }}" 
    deletebutton="{{ route('admin.carbrands.deleteAll') }}" 
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
...
{{-- import files model --}}
<x-admin.ImportFile route="{{ route('admin.carbrands.importFile') }}" />
{{-- import files  model --}}  
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/carbrands')])
