            ...
            @foreach($complaints as $complaint)
                <tr class="delete_complaint">
                    ...
                    <td class="product-action">
                        <span class="action-edit text-primary"><a href="{{ route('admin.complaints.show', ['id' => $complaint->id]) }}" class="btn btn-warning btn-sm"><i class="feather icon-eye"></i> {{ __('admin.show') }}</a></span>
