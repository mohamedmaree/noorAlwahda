...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.pricecategories.create') }}" 
    deletebutton="{{ route('admin.pricecategories.deleteAll') }}" 
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/pricecategories')])
@endsection
