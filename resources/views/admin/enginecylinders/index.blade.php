...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.enginecylinders.create') }}" 
    deletebutton="{{ route('admin.enginecylinders.deleteAll') }}" 
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/enginecylinders')])
@endsection
