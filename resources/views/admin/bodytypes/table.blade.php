<div class="position-relative">
    ...
    <table class="table " id="tab">
        ...
        <tbody>
            @foreach ($bodytypes as $bodytypes)
                <tr class="delete_row">
                    <td class="text-center">
                        <label class="container-checkbox">
                        <input type="checkbox" class="checkSingle" id="{{ $bodytypes->id }}">
                        <span class="checkmark"></span>
                        </label>
                    </td>
                    ...
                    <td class="product-action"> 
                        ...
                        <span class="delete-row btn btn-danger btn-sm" data-url="{{ url('admin/bodytypes/' . $bodytypes->id) }}"><i class="feather icon-trash"></i>{{ __('admin.delete') }}</span>
                    </td>
                </tr>
            @endforeach
        </tbody>
...
@if ($bodytypes->count() > 0 && $bodytypes instanceof \Illuminate\Pagination\AbstractPaginator )
