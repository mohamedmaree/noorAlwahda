...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.carstatushistories.create') }}" 
    deletebutton="{{ route('admin.carstatushistories.deleteAll') }}" 
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/carstatushistories')])
@endsection
