...
<x-admin.table 
    ...
    order="true" 
    extrabuttons="true"
    addbutton="{{ route('admin.enginetypes.create') }}" 
    deletebutton="{{ route('admin.enginetypes.deleteAll') }}" 
    :searchArray="[
        'name' => [
            'input_type' => 'text' , 
...
@section('js')
    ...
    @include('admin.shared.filter_js' , [ 'index_route' => url('admin/enginetypes')])
@endsection
