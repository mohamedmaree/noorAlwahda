        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card" style="direction: {{ lang() == 'ar' ? 'rtl':'ltr' }};">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-1 pt-2">{{__('site.remove_account')}} </h4>
              {{-- <p class="mb-4">Please sign-in to your account and start the adventure</p> --}}

              <form id="formAuthentication" class="mb-3" action="{{route('remove-account')}}"  method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                  <button class="btn btn-danger d-grid w-100 submit_button" type="submit">{{__('site.delete')}}</button>
                </div>
              </form>
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if (response.status == 1){
                            ...
                            $(".submit_button").html(`<i class="ft-unlock"></i> {{ __('site.delete') }}`).attr('disable',false)
                    ...
                    error: function (xhr) {
                        $(".submit_button").html("{{ __('site.delete')}}").attr('disable',false)
                        $(".text-danger").remove()
